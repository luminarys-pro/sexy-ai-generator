# ---------------- streamlit_app.py (Versión Final, Estable y Robusta) ----------------
...
def get_model_response(prompt_text):
    try:
        ...
        st.error("La IA devolvió un formato de texto inesperado. No se pudo interpretar.")
...
Una vez que confirmemos que esta versión funciona, avanzaremos juntos para construir el "Asistente de DMs" sobre esta base sóli